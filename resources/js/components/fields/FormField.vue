        ...
        <template slot="field">
            <div :class="{'px-8 pt-6': field.fullSize}">
                <gallery slot="value" ref="gallery" v-if="hasSetInitialValue"
                    ...
                    <template slot="existing-media" v-if="field.existingMedia">
                        <button type="button" class="form-file-btn btn btn-default btn-primary mt-2 ml-2"
                                @click="existingMediaOpen = true">
                ...
                <div v-if="field.existingMedia">
                    <existing-media :open="existingMediaOpen" @close="existingMediaOpen = false"
